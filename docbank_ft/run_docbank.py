...
def main():
    ...
    parser = HfArgumentParser((ModelArguments, DocBankDataTrainingArguments, TrainingArguments))
    ...
    datasets = {
        'train': DocBankDataset(args=data_args, tokenizer=tokenizer, mode='train'),
        'valid': DocBankDataset(args=data_args, tokenizer=tokenizer, mode='valid'),
        'test': DocBankDataset(args=data_args, tokenizer=tokenizer, mode='test')
    }
